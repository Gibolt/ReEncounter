...
CREATE TABLE EncounterDetails (
	...
	User2	   VarChar(30)   Not Null,
	Time	   DateTime      Not Null,
	Distance   Decimal(14,8) Not Null,
	Latitude1  Decimal(14,8) Not Null,
	Longitude1 Decimal(14,8) Not Null,
	Latitude2  Decimal(14,8) Not Null,
	Longitude2 Decimal(14,8) Not Null,
	FOREIGN KEY (User1) REFERENCES Users (User),
	FOREIGN KEY (User2) REFERENCES Users (User),
